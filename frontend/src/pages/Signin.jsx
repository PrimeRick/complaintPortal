    ...
    return (
        <div className="flex flex-col">
            <div className="flex bg-black">
                <div className="w-full flex-col md:w-2/5 bg-white flex justify-center items-center h-screen max-sm:hidden max-md:hidden">
                    <div className="flex flex-col items-center">
                        <img src={ongc_logo} alt="" className="h-44 w-44" />
                        <br />
                        <h1 className="text-4xl font-bold mb-4 text-red-700 w-80 text-center">Online Complaints Management System</h1>
                        <h2 className="text-3xl font-semi-bold mb-4 text-green-500 w-80 text-center">(Hazira Plant, Surat)</h2>
                    </div>
                            ...
                            <div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
                                <div className='bg-white py-12 px-4 shadow sm:rounded-lg sm:px-10'>
                                    <div className='flex flex-col items-center justify-center gap-4'>
                                        ...
                                        <InputBox Icon={"CPF"} type={"text"} label={"CPF"} stateVariable={cpf} onChange={(e) => setCpf(Number(e.target.value))} />
                                        <InputBox Icon={"Password"} type={"password"} label={"Password"} stateVariable={password} onChange={(e) => setPassword(e.target.value)} />
                                        {invalid ?
