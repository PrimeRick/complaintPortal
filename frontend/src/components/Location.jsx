...
//   import { IconType } from "react-icons";
  ...
  const Location = ({type, location, setLocation}) => {
      ...
      <div className="p-4 pb-56 flex items-center justify-center bg-white">
        <motion.div animate={open ? "open" : "closed"} className="relative">
          ...
          >
            {type=='Housekeeping'?
            <>
                <Option setOpen={setOpen} Icon={FiPlusSquare} setLocation={setLocation} text="Plant" />
            </>:
            <>
                <Option setOpen={setOpen} Icon={FiEdit} setLocation={setLocation} text="Colony" />
                <Option setOpen={setOpen} Icon={FiPlusSquare} setLocation={setLocation} text="Plant" /> 
            </>
            }
          </motion.ul>
  ...
  const Option = ({ text, Icon, setOpen, setLocation }) => {
    return (
      <motion.li
