  ...
  const Option = ({ text, Icon, setOpen, setType }) => {
	return (
	  <motion.li
		...
		className="z-30 flex items-center gap-2 w-full p-2 text-xs font-medium whitespace-nowrap rounded-md hover:bg-indigo-100 text-slate-700 hover:text-indigo-500 transition-colors cursor-pointer"
	  >
